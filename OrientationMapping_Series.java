...
*/
  ...
  // Program information
  String pluginName = "OrientationMapping_Series";
  ...
  public void run(String arg) {
    ...
    */
    ...
    // Prepare an RGB image stack for the results
    ImageStack resultIs = new ImageStack(width, height);
    ...
    for (int i=0; i<nSlicesSeries; i++) {
        ...
        resultIs.addSlice(sliceTitle, temp.getProcessor());
        
    }
    
    // show the result
    ImagePlus result = new ImagePlus("Orientation maps of " + seriesTitle, resultIs);
    result.show();
